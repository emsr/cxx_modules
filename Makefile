...
foobar.nms foobar.o: foobar.cpp
	$(HOME)/bin_modules/bin/g++ -std=c++17 -fmodules-ts -fmodule-wrapper=false -c foobar.cpp

foo.o: foobar.nms foo.cpp
	$(HOME)/bin_modules/bin/g++ -std=c++17 -fmodules-ts -fmodule-wrapper=false -c foo.cpp

bar.o: foobar.nms bar.cpp
	$(HOME)/bin_modules/bin/g++ -std=c++17 -fmodules-ts -fmodule-wrapper=false -c bar.cpp

toy.o: foobar.nms toy.cpp
	$(HOME)/bin_modules/bin/g++ -std=c++17 -fmodules-ts -fmodule-wrapper=false -c toy.cpp
